package com.derrick.park.sqlitetest;
...
//        Log.d(TAG, "onCreate: " + sql);
//        sqLiteDatabase.execSQL(sql);
//        sql = "INSERT INTO contacts VALUES('Derrick', 12345, 'derrick@email.com');";
//        Log.d(TAG, "onCreate: " + sql);
//        sqLiteDatabase.execSQL(sql);
//        sql = "INSERT INTO contacts VALUES('Leo', 54321, 'leo@email.com');";
//        Log.d(TAG, "onCreate: " + sql);
//        sqLiteDatabase.execSQL(sql);
